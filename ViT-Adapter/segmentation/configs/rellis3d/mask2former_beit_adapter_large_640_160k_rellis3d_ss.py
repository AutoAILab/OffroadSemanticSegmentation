...
_base_ = [
    '../_base_/models/mask2former_beit_rellis3d.py',
    '../_base_/datasets/rellis3d.py',
    '../_base_/default_runtime.py',
    '../_base_/schedules/schedule_160k.py'
]
crop_size = (640, 640)
# @ToDo: see if the commented pretrained works or not.
# pretrained = 'https://conversationhub.blob.core.windows.net/beit-share-public/beit/beit_large_patch16_224_pt22k_ft22k.pth'
pretrained = '/scratch/ndang/OffRoadSemanticSegmentation/ViT-Adapter/segmentation/pretrained/beit_large_patch16_224_pt22k_ft22k.pth'
...
# evaluation = dict(interval=150, metric='mIoU', save_best='mIoU')
