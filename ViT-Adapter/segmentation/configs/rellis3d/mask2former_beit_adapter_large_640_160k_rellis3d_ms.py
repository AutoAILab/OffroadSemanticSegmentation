...
pretrained = '/scratch/ndang/OffRoadSemanticSegmentation/OffRoadSemanticSegmentation/ViT-Adapter/segmentation/pretrained/beit_large_patch16_224_pt22k_ft22k.pth'
...
val_pipeline = [
    ...
    dict(
        ...
        img_scale=(1920, 1200),
        # img_ratios=[0.5, 0.75, 1.0, 1.25, 1.5, 1.75], modified by Nobel
