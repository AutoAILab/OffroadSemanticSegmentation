...
def parse_args():
    ...
    parser.add_argument('--data-cfg', help='data config (kitti format)',
                        default='/project/bli4/autoai/nobel/OffRoadSemanticSegmentation/OffRoadSemanticSegmentation/benchmarks/RELLIS-3D/benchmarks/SalsaNext/train/tasks/semantic/config/labels/rellis.yaml',
                        type=str)
